...
public class TinyStateMachine {
    ...
    public interface Handler {
         ...
         * @param param parameter passed to {@link TinyStateMachine#handle(int, Object)}
    ...
    public TinyStateMachine() {
        this(0);
    }

    public TinyStateMachine(@IntRange(from = 0) int initialState) {
        mState = initialState;
        ...
        while (!mCommands.isEmpty()) {
            ...
            switch (cmd.mType) {
                ...
                case Command.COMMIT:
                    ...
                    break;
                default:
                    Log.e(TAG, "Unknown command type: " + cmd.mType);
                    break;
            }
        }
    }
